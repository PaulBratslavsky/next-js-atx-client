    ...
    >
      {servicesData.map((service, index) =>
        service.title && service.description ? (
          <div
            key={index}
            className="relative bg-customPurple p-8 pr-14 md:px-10 md:py-12 xl:px-12 xl:py-14 rounded-3xl shadow-customShadow hover:shadow-customShadowHover transition ease-out duration-150 dark:bg-customPurpleDarker"
          >
