...
export const servicesData = [
    {
        icon: 'bi bi-globe',
        title: 'ATX Monthly Meetup where you can learn and teach your skills.',
    },
    {
        icon: 'bi bi-bar-chart',
        title: 'Meet in person every few months in Austin, TX.',
    },
    {
        title: '390+',
...
export const footerData = {
    copyright: 'Next.js ATX. All rights reserved.',
